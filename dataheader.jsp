	...
	<div class="header" id="home">
		<div class="banner_header_top_wthree">
			<div class="agileits-logo">
				...
				Secure Cloud Storage with Smooth Projective Hash Functioning</a></h1>
			</div>
						...
						<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
							<nav class="link-effect-2" id="link-effect-2">
								<ul class="nav navbar-nav">
									<li class="active" class="scroll"><a href="OwnerHome.jsp"><span data-hover="Home">Home</span></a></li>
									<li class="active"class="scroll"><a href="fileupload.jsp"><span data-hover="File Upload">File Upload</span></a></li>
									<li class="active" class="scroll"><a href="index.html"><span data-hover="LogOut">LogOut</span></a></li>
