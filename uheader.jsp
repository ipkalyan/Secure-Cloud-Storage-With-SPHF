						...
						<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
							<nav class="link-effect-2" id="link-effect-2">
								<ul class="nav navbar-nav">
									<li class="active" class="scroll"><a href="UserHome.jsp"><span data-hover="Home">Home</span></a></li>
									<li class="active"class="scroll"><a href="filedownload.jsp"><span data-hover="Search">Search</span></a></li>
